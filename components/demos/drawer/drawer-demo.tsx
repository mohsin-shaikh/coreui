      ...
      <Drawer.Content>
        ...
        <Drawer.Body>
          ...
          <div className='space-y-2.5 px-5 py-3.5'>
            ...
            <TransactionItem>
              <div className='bg-success-lighter flex size-10 shrink-0 items-center justify-center rounded-full'>
                <RiHomeSmileFill className='text-success-base size-5' />
              </div>
              <div className='min-w-0 flex-1 space-y-1'>
                <div className='text-label-sm text-text-strong-950'>
                  Rental Income
            ...
            <TransactionItem>
              <div className='bg-bg-white-0 shadow-regular-xs ring-stroke-soft-200 flex size-10 shrink-0 items-center justify-center rounded-full ring-1 ring-inset'>
                <RiShoppingCartLine className='text-text-sub-600 size-5' />
              </div>
              <div className='min-w-0 flex-1 space-y-1'>
                <div className='text-label-sm text-text-strong-950'>
                  Grocery Shopping
            ...
            <TransactionItem>
              <div className='bg-bg-white-0 shadow-regular-xs ring-stroke-soft-200 flex size-10 shrink-0 items-center justify-center rounded-full ring-1 ring-inset'>
                <RiPieChartLine className='text-text-sub-600 size-5' />
              </div>
              <div className='min-w-0 flex-1 space-y-1'>
                <div className='text-label-sm text-text-strong-950'>
                  Stock Dividend
            ...
            <TransactionItem>
              <div className='bg-away-lighter flex size-10 shrink-0 items-center justify-center rounded-full'>
                <RiLightbulbFlashFill className='text-away-base size-5' />
              </div>
              <div className='min-w-0 flex-1 space-y-1'>
                <div className='text-label-sm text-text-strong-950'>
                  Electricity Bills
