...
export default function TabMenuVerticalStyledContainer() {
  return (
    <div className='w-full max-w-[258px]'>
      <TabMenuVertical.Root
        defaultValue='Profile Settings'
        className='bg-bg-white-0 shadow-regular-xs ring-stroke-soft-200 rounded-2xl p-2.5 ring-1 ring-inset'
      >
