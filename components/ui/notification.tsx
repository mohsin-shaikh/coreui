...
>(({ className, ...rest }, forwardedRef) => (
  <NotificationPrimitives.Viewport
    ref={forwardedRef}
    className={cn(
      'fixed left-0 top-0 z-100 flex max-h-screen w-full flex-col-reverse gap-5 p-4 sm:bottom-0 sm:left-auto sm:right-0 sm:top-auto sm:max-w-109.5 sm:flex-col sm:p-6',
      className,
    )}
    {...rest}
  />
