      ...
      >
        ...
        {showArrow && (
          <PopoverPrimitive.Arrow asChild>
            <div className='size-2.75 -translate-y-[calc(50%+1px)] -rotate-45 rounded-bl-[3px] border border-stroke-soft-200 bg-bg-white-0 [clip-path:polygon(0_100%,0_0,100%_100%)]'></div>
