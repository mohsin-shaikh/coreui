...
export const fileFormatIconVariants = tv({
  slots: {
    ...
    formatBox:
      'absolute bottom-1.5 left-0 flex h-4 items-center rounded px-0.75 py-0.5 text-[11px] font-semibold leading-none text-static-white',
  },
  variants: {
    size: {
      medium: {
